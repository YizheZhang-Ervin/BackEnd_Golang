...
import (
	...
	"fmt"
	"image/png"
	getArea "my-microservice2/proto/getArea/proto/getArea"
	getImg "my-microservice2/proto/getImg/proto/getImg"
	houseMicro "my-microservice2/proto/house/proto/house"
	orderMicro "my-microservice2/proto/order/proto/userOrder"
	register "my-microservice2/proto/register/proto/register"
	user "my-microservice2/proto/user/proto/user"
	"my-microservice2/utils"
	"net/http"
	"path"
